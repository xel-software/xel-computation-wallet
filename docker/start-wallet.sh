...
if [ ! -z ${nxt_enableComputationEngine+x} ]
then
  echo "set nxt.enableComputationEngine=${nxt_enableComputationEngine}"
  echo "nxt.enableComputationEngine=${nxt_enableComputationEngine}" >> ${CONFIG_FILE}
fi
