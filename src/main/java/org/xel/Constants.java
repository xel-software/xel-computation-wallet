...
public final class Constants {
    ...
    public static final long TENTH_NXT = isTestnet ? 100 : 10000000;
    ...
    public static final int[] MIN_VERSION = new int[] {4, 0, 0};
    public static final int[] MIN_PROXY_VERSION = new int[] {4, 0, 0};
